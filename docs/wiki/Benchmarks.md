...
4. a product whose stable workflow compiles URLs selected by the host agent

## Reading Experimental Seedless Correctly

Seedless discovery is an explicit experimental surface, not part of the stable skill or market claim.
...
Experimental evaluation still requires:
...
5. multi-run evidence before any promotion decision
